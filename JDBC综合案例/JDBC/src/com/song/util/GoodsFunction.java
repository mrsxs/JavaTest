...
public class GoodsFunction {
    ...
    private static void compoundQuery() {
        ...
        for (Goods good : list) {
            System.out.println(good.getGoodsId() + "\t" + good.getGoodsName() + "\t" + good.getPrice() + "\t"
                    + good.getCategory().getCategoryName() + "\t" + good.getOffers().getOfferName() + "\t"
                    + good.getStockes());
        }
        sc.close();
    }
    ...
    static void queryOffers() {
        ...
        for (Offers offer : offers) {
            System.out.println(offer.getOfferId() + "\t" + offer.getOfferName() + "\t" + offer.getAddress() + "\t"
                    + offer.getTel());
        }
    }
}